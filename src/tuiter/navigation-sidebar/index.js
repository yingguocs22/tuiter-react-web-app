...
const NavigationSidebar = () => {
    ...
    return (
        <div className="list-group">
            ...
            <Link to="/tuiter/home2" className={`list-group-item ${active === 'home'?'active':''}`}>
                <i className="bi bi-house-door-fill me-1" /> Home
            </Link>

            <Link to="/tuiter/explore2" className={`list-group-item ${active === 'explore'?'active':''}`}>
            ...
            <Link to="/tuiter/profile2" className={`list-group-item
